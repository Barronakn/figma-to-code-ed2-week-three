...
const Navbar = () => {
  ...
  return (
    <div className="flex flex-row items-center justify-between sm:gap-5 gap-1.5 dark:text-gray-200 dark:[#484B52] px-0 sm:px-6 py-3 bg-white dark:bg-dark-blue-1">
        <img onClick={toggleMenu} className="block rounded-10 border border-gray lg:hidden p-2" src={menu} alt="menu-icon" />
      ...
      <div className="flex flex-row gap-1.5 items-center justify-center sm:gap-3">
        <div className="flex flex-row gap-0.5 items-center cursor-pointer border border-gray dark:border-opacity-15 p-2 rounded-10 px-2 sm:px-5 sm:py-2.5">
          <span className="text-gray text-xs text-center text-nowrap font-medium">USD</span>
